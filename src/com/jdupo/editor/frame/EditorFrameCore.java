...
import com.jdupo.listener.EditorListener;
...
public abstract class EditorFrameCore extends ApplicationWindow {
	...
	protected EditorAction saveTheory = new SaveUsagePolicy();
	...
	protected StatusLineManager createStatusLineManager() {
		...
		slm.setMessage("Welcome to jDUPO");
	...
	protected CoolBarManager createCoolBarManager(int style) {
		...
		mainToolbar.add(new LoadUsagePolicy());
	...
	protected MenuManager createMenuManager() {
		final EditorAction saveTheoryAs = new SaveUsagePolicyAs();
		final EditorAction saveConclusions = new SaveConclusions();
		final EditorAction saveConclusionsAs = new SaveConclusionsAs();
		final EditorAction closeTheory = new CloseUsagePolicyFile();
		final EditorAction closeAllTheories = new CloseAllUsagePolicyFiles();

		final EditorAction newLiteralVariable=new NewLiteralVariable();
		final EditorAction newRule = new CreateRequest();
		final EditorAction newSuperiority = new NewSuperiority();
		final EditorAction newModeRule = new NewModeRule();

		MenuManager fileMenu = new MenuManager("&Data Providers");
		fileMenu.add(new NewTheory());
		fileMenu.add(new LoadUsagePolicy());
		...
		fileMenu.add(new DataManagement());
		fileMenu.add(new Separator());
		fileMenu.add(new DataUsageHistory());
		...
		MenuManager editMenu = new MenuManager("&Data Consumers");
		...
		newRule.setText("Create Request");
		newRule.setToolTipText("Create Request");
		...
		editMenu.add(new Separator());
		editMenu.add(new VisualizeReturnedData());
		
		editMenu.add(new Separator());
		editMenu.add(new VisualizeJustification());
		

		MenuManager runMenu = new MenuManager("&Data Usage Control Module");
