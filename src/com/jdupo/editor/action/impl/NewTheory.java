...
public class NewTheory extends EditorAction {
	public static final String LABEL = "&Create Usage Policy";
	private static final String TOOL_TIP = "Create Usage Policy";
	private static final int ACCELERATOR = SWT.CTRL | 'N';
	private static final String ICON = "/com/jdupo/resources/new.gif";
