...
public class SaveUsagePolicyAs extends EditorAction {
	public static final String LABEL = "Save Usage Policy as...";
	private static final String TOOL_TIP = "Save Usage Policy to Another File";
	private static final int ACCELERATOR = -1;
	private static final String ICON = "";

	public SaveUsagePolicyAs() {
